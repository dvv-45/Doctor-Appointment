...
app.use(cors({
    origin: ['http://localhost:5173', 'http://localhost:5174', 'http://localhost:5175','https://doctor-appointment-frontend-2wmr.onrender.com','https://doctor-appointment-admin-2iin.onrender.com'
    ], // <--- ADD 5175 HERE!
